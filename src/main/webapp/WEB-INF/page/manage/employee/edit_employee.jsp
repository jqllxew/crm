...
<body>
	...
	<form id="form" method="post">
		...
		<table cellspacing="10" cellpadding="0" style="margin-left: 70px">
			<tr>
				<td class="tl">员工姓名:</td>
				<td><input type="text" name="name" value="${emp.name }" class="easyui-textbox theme-textbox-radius"  data-options="required:true" readonly="readonly"></td>
			</tr>
			<tr>
				<td class="tl">联系电话:</td>
				<td><input type="text" class="easyui-textbox theme-textbox-radius" value="${emp.telephone }" data-options="required:true" name="telephone"></td>
			</tr>
			<tr>
				<td class="tl">邮箱:</td>
				<td><input type="text" name="email" value="${emp.email }"  class="easyui-textbox theme-textbox-radius"></td>
			</tr>
			<tr>
				<td class="tl">地址:</td>
				<td><input name="address" value="${emp.address }" class="easyui-textbox theme-textbox-radius"></td>
			</tr>
			<tr>
